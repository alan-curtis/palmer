...
class Multilevel_Navigation_Menu_WP {
	 ...
	 *
	 */
	public function mnmwp_menu_selection_admin_notice() {
	 ...
	 * @return void
	 */
	public function mnmwp_active_function() {
	 ...
	 * @return void
	 */
	public function mnmwp_activation_redirect( $plugin ) {
	 ...
	 * @return void
	 */
	public function mnmwp_frontend_assets() {
	 ...
	 * @return void
	 */
	public function mnmwp_add_menu() {
		add_theme_page(
	 ...
	 *
	 */
	public function mnmwp_register_menu() {
	 ...
	 * @return array
	 */
	public function mnmwp_add_link( $links ) {
		return array_merge(
			array(
				'settings' => sprintf(
					'<a href="%1$s">%2$s</a>',
	 ...
	 * Plugin Pages
	 */
	public function mnmwp_menu_page() {
	 ...
	 * @return void
	 */
	public function mnmwp_setting_display() {
	 ...
	 * @return void
	 */
	public function mnmwp_content_callback() {
	...
	public function mnmwp_first_background_color() {
	...
	public function mnmwp_first_font_color() {
	...
	public function mnmwp_second_background_color() {
	...
	public function mnmwp_second_font_color() {
	...
	public function mnmwp_rest_background_color() {
	...
	public function mnmwp_rest_font_color() {
	...
	/** MNM Menu Icon Field **/
	public function mnmwp_menu_icon_color() {
	...
	public function mnmwp_menu_outer_width() {
	...
	public function mnmwp_menu_inner_width() {
	...
	public function mnmwp_mobile_menu_breakpoint() {
	...
	public function mnmwp_menu_shortcode() {
	 ...
	 * @return void
	 */
	public function mnmwp_setting_element() {
	 ...
	 * @return integer
	 */
	public function mnmwp_sanitize_checkbox( $input ) {
		return ( '1' !== $input ) ? 0 : 1;
	}
	 ...
	 *
	 */
	public function mnmwp_menu_section_sc($atts){
