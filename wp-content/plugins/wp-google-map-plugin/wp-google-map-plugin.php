...
if ( ! class_exists( 'FC_Google_Maps_Lite' ) ) {
	...
	class FC_Google_Maps_Lite
	{
		...
		function wpgmp_go_pro_link($actions) {
			...
			$actions['go_pro'] = '<a style="color:#ff0000;" target = "_blank" href="https://www.wpmapspro.com/?utm_source=wordpress&utm_medium=liteversion&utm_campaign=freemium&utm_id=freemium">'.esc_html__( 'Pro Version', 'wp-google-map-plugin' ).'</a>';
