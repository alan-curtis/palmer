=== WP MAPS - Easiest & Most Advanced WordPress Plugin for Google Maps ===
...
A fully customizable WordPress Plugin for Google Maps. Create unlimited Google Maps Shortcodes, assign unlimited locations with custom infowindow messages and add to pages, posts and widgets.

== Description ==

Adding a Google Maps on a WordPress Site is easy now! This plugin allows to display Google Maps with multiple locations, custom infowindow messages with various Google Maps Controls. Apply Snazzy Maps Styles to Google Maps in seconds.

Contact [Dedicated Support team](https://www.flippercode.com/support) for configurations.
