...
if (!class_exists('\Wpo\Services\Audiences_Service')) {
    ...
    class Audiences_Service
    {
        ...
        public static function audiences_add_meta_box($post_type, $post)
        {
            ...
            // Do nothing if audiences has not been enabled or the user didn't enable the audience meta box
            if (empty(Options_Service::get_global_boolean_var('enable_audiences')) || empty(Options_Service::get_global_boolean_var('enable_audiences_meta_box'))) {
                return;
            }
        ...
        public static function audiences_render_meta_box($post)
        {
            ...
            if (false !== stripos($auth_scenario, 'internet') || $currently_private) {
            ...
            echo sprintf(
                ...
                false !== stripos($auth_scenario, 'internet') ? 'Alternatively, you' : 'You'
            );
        ...
        public static function audiences_save_post($post_id, $post, $update)
        {
            ...
            if (isset($_POST['wpo365_private']) && false !== stripos($_POST['wpo365_private'], 'on')) {
