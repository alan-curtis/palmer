					...
					<div class="mmp-batch-settings">
						<form id="mapSettings" method="POST">
							...
							<div id="geocodingControlContent" class="mmp-map-batch-settings-group">
								...
								<div class="mmp-map-batch-setting mmp-advanced">
									<div class="mmp-map-setting-desc">
										<input type="checkbox" id="geocodingControlProviderCheck" class="batch-settings-check" name="geocodingControlProviderCheck" />
										<label for="geocodingControlProvider"><?= esc_html__('Geocoding provider', 'mmp') ?></label>
									</div>
									<div class="mmp-map-setting-input">
										<select id="geocodingControlProvider" name="geocodingControlProvider">
											<optgroup label="<?= esc_attr__('Available providers', 'mmp') ?>">
												<option value="algolia" <?= $settings['geocodingControlProvider'] !== 'algolia' ?: 'selected="selected"' ?>>Algolia Places</option>
												<?php if ($settings['geocodingLocationIqApiKey']): ?>
													<option value="locationiq" <?= $settings['geocodingControlProvider'] !== 'locationiq' ?: 'selected="selected"' ?>>LocationIQ</option>
												<?php endif; ?>
												<?php if ($settings['geocodingMapQuestApiKey']): ?>
													<option value="mapquest" <?= $settings['geocodingControlProvider'] !== 'mapquest' ?: 'selected="selected"' ?>>MapQuest</option>
												<?php endif; ?>
												<?php if ($settings['geocodingGoogleApiKey']): ?>
													<option value="google" <?= $settings['geocodingControlProvider'] !== 'google' ?: 'selected="selected"' ?>>Google</option>
												<?php endif; ?>
												<?php if ($settings['geocodingTomTomApiKey']): ?>
													<option value="tomtom" <?= $settings['geocodingControlProvider'] !== 'tomtom' ?: 'selected="selected"' ?>>TomTom</option>
												<?php endif; ?>
											</optgroup>
					...
					<div>
						...
						<div id="health_check_result">
							<ul>
								...
								<li><?= esc_html__('API endpoint', 'mmp') ?>: <?= $this->yes_no(!is_wp_error($debug_info['api_response']) && wp_remote_retrieve_response_code($debug_info['api_response']) === 302) ?></li>
							</ul>
