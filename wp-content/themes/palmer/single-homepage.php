...
the_post();
?>
    <div class="main-container homepage-content-type" role="main" style="position: relative">
        <img class="spine-cord" src="/wp-content/themes/palmer/dist/images/spine-full.svg" alt="spine cord" style="position: absolute;bottom: -3px;top: unset;left: -26px;width: 304px;height: 1876px;">
        <?php if (have_rows('hp_component_hero')) {
            while (have_rows('hp_component_hero')) {
                the_row();
...
<?php
        ...
        if (have_rows('hp_components_full')) {
            while (have_rows('hp_components_full')) {
                the_row();
