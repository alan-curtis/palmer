...
?>
    ...
    <div class="main-container basic-page" role="main">
        <!-- <section class="campuslocations mt-5">
            <div class="container">
                <?php
        // if (is_page(190)) {
        //     echo do_shortcode('[mapsmarker map="1"]');
        // }
        // if (is_page(240)) {
        ...
        <div class="container columnsblock">
            <div class="row">
                ...
                <div class="col-lg-8 main-column"  id="content">
                    ...
                    if (have_rows('components_maincolumn')) {
                        while (have_rows('components_maincolumn')) {
                            $object_counter++;
                            the_row();
                            ...
                            if (get_row_layout() == 'testimonial_carousel') {
                                get_template_part('components/testimonial', 'carousel', $args = array('carousel_items' => get_sub_field('carousel_items'), 'title' => get_sub_field('title'), 'obj_count_id' => $object_counter));
                            }
                        ...
                        if (get_row_layout() == 'flexible_wysiwyg') {
                            get_template_part('components/flexible', 'wysiwyg', $args = array('wysiwyg_repeater' => get_sub_field('wysiwyg_repeater')));
                        }
        ...
        $fields = acf_get_fields('group_6189fe161a028');
                ...
                if (have_rows('components')) {
                    while (have_rows('components')) {
                        ...
                        if (get_row_layout() == 'image_collage') {
                            get_template_part('components/image', 'collage', $args = array('title' => get_sub_field('title'), 'caption' => get_sub_field('caption'), 'link' => get_sub_field('link'), 'images' => get_sub_field('images'), 'title' => get_sub_field('title')));
                        }
                        ...
                        if (get_row_layout() == 'blockquote') {
                            get_template_part('components/blockquote', 'section', $args = array('body' => get_sub_field('body'), 'author' => get_sub_field('author')));
                        }
                        if (get_row_layout() == 'testimonial_carousel') {
                                get_template_part('components/testimonial', 'carousel', $args = array('carousel_items' => get_sub_field('carousel_items'), 'title' => get_sub_field('title'), 'obj_count_id' => $object_counter));
                            }
